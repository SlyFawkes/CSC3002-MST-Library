...
#include "../src/KruskalSolver.h"

class KruskalSolverTest : public ::testing::Test {
protected:
...
TEST_F(KruskalSolverTest, getMST) {
    CSRGraph csrGraph = CSRGraph();
    csrGraph.numberOfNodes = 10;
    csrGraph.numberOfEdges = 42;
    size_t nodeList[csrGraph.numberOfNodes + 1] ={0, 4, 8, 13, 16, 20, 24, 28, 34, 39, 42};
    size_t edgeList[csrGraph.numberOfEdges] = {1, 2, 8, 9, 0, 2, 7, 8, 0, 1, 3, 4, 7, 2, 4, 5, 2, 3, 5, 7, 3, 4, 6, 7, 5, 7, 8, 9, 1, 2, 4, 5, 6, 8, 0, 1, 6, 7, 9, 0, 6, 8};
    ...
    csrGraph.nodeList = new size_t[csrGraph.numberOfNodes + 1];
    csrGraph.edgeList = new size_t[csrGraph.numberOfEdges];
    ...
    KruskalSolver kruskalSolver = KruskalSolver(&csrGraph);
